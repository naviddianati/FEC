...
set_vertexSize(G, s_max=40, s_min=1)
set_edgeWidth(G, w_max=30, w_min=1, threshold=None, percent=None)
# print G.es['color']
set_labelSize(G, s_max=30, s_min=10, percent=5)
...
set_vertexColor(G, field=None, palette=pal, cluster=True)
